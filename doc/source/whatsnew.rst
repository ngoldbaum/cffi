...
* On Python 3.10 and 3.11, the cyclic garbage collector is paused while CFFI
  realizes or completes a type, so a finalizer can no longer reenter type
  construction halfway through and create duplicate type objects.
